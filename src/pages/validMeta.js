...
export default class validMeta extends Component {
	...
	validate(){
		...
		Blob
			...
			.then((blob) => {
			  ...
			  var uploadTask= firebase.storage()
				.ref()
				.child('medecins'+'_'+this.state.array.medecin_id).child('categories'+'_'+'grain_de_beaute').child('patients'+'_'+this.state.array.patient_id).child('dossiers_medicaux'+'_'+this.state.array.dossier_id).child('images')
				.child(testImageName)
		...
		this.itemsRef.child('medecins').child(this.state.array.medecin_id).child('categories').child('grain_de_beaute').child('patients').child(this.state.array.patient_id).child('dossiers_medicaux').child(this.state.array.dossier_id).child('images').child(image_id).set({ 
