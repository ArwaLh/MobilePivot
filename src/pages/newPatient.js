...
export default class newPatient extends Component {
	...
	locatePic(){
		...
		AsyncStorage.getItem('id').then((idd) => {
			...
			AsyncStorage.setItem('med_pat_file',JSON.stringify({"medecin_id":medecin_usernamee,"patient_id":patient_id,"nom_pat":this.state.nom_pat,"prenom_pat":this.state.prenom_pat,"categorie": idd,"dossier_id":dossier_id,"nombre_images_dossier":0}));
